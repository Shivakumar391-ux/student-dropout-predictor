...
def load_and_train():
    ...
    df_reg = df[df['Target'] != 'Dropout'].copy()
    X_reg = df_reg.drop(columns=['Target', 'Dropout_risk', 'Curricular units 2nd sem (grade)'])
    y_reg = df_reg['Curricular units 2nd sem (grade)']
